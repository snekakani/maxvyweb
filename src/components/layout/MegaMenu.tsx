        ...
        <div className="grid grid-cols-1 md:grid-cols-[280px_1fr]">
          ...
          <div className="p-6 max-h-[500px] overflow-y-auto scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-transparent hover:scrollbar-thumb-slate-400">
            <div className="mb-5 flex items-start gap-4 pb-4 border-b border-slate-100">
              <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-primary-500 text-white shadow-md shadow-primary-200">
              ...
              {active.items && active.items.length > 0 ? (
                active.items.map((item) => (
                  <li key={item.path} className="list-none">
                    ...
                    >
                      <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary-400 transition-all group-hover:bg-primary-500 group-hover:scale-125" />
                      <span>
                        <span className="block text-sm font-medium text-slate-700 transition-colors group-hover:text-primary-600">
                          {item.name}
                        </span>
