export const productContent = {
  ...
  'spd5-hub-interface-ip': {
    ...
    category: 'ddr5',
    heroTitle: 'DDR5 SPD HUB INTERFACE IP',
    heroDescription: 'Accelerating next-generation memory communication with secure and reliable SPD5 connectivity.',
    title: 'DDR5 SPD Hub Interface IP - Serial Presence Detect Hub Controller',
    seoKeywords: 'DDR5 SPD Hub Interface, SPD5 Hub Interface, DDR5 SPD Hub IP, SPD5 Hub, DDR5 Memory Hub Interface, SPD Hub IP, DDR5 Memory SPD Hub, DDR5 SPD Controller IP, SPD5 Controller, DDR5 SPD Interface, DDR5 Serial Presence Detect Interface, DDR5 SPD Controller, DDR5 Memory Hub, SPD Hub Controller IP, DDR5 Serial Presence Detect Hub',
    overview: 'The SPD5 Hub Function IP has been developed to interface I3C/I2C Host Bus and it allows an isolation of local devices like Temperature Sensor(TS), from master host bus. This SPD5 has Two wire serial interface like SCL, SDA. The DDR5 Serial Presence Detect (SPD) Hub Interface IP is a silicon-proven, JEDEC JESD300-5 compliant solution designed for DDR5 DIMM and NVDIMM applications. It serves as a DDR5 Memory Hub Interface, enabling seamless communication between the host controller and local devices while supporting both I2C and I3C Basic modes. This SPD Hub IP integrates a DDR5 SPD Controller with comprehensive features including Bus Reset, SDA arbitration, Parity Check, and Packet Error Check (PEC). The SPD5 Controller supports NVM memory access and register space operations, making it an ideal DDR5 Memory SPD Hub solution for demanding applications.',
  ...
  'temperature-sensor': {
    ...
    category: 'ddr5',
    heroTitle: 'DDR5 TEMPERATURE SENSOR',
    heroDescription: 'High-accuracy on-die temperature sensing for next-generation memory modules.',
    title: 'DDR5 Temperature Sensor IP - I2C/I3C Thermal Sensor for Memory Modules',
    seoKeywords: 'DDR5 Temperature Sensor, DDR5 Temperature Sensor I2C, DDR5 Temperature Sensor I3C, DDR5 Memory Temperature Sensor, DDR5 I2C Temperature Sensor, DDR5 I3C Temperature Sensor, DDR5 Temperature Sensor I2C I3C, DDR5 Temperature Sensor IP, DDR5 Thermal Sensor, DDR5 Thermal Sensor I3C, DDR5 Thermal Sensor IP, DDR5 Thermal Sensor I2C, DDR5 Temperature Monitoring IP, DDR5 Temperature Sensor I2C Interface, DDR5 Temperature Sensor I3C Interface, DDR5 Temperature Sensor Interface',
    badges: ['Silicon Proven', 'IP Proven'],
    overview: 'The TS5111 and TS5110 device incorporate thermal sensing capability which is controlled and read over two wire bus. These device operate on I2C and I3C two wire serial bus interface. The TS5 designed for Memory Module Applications. The TS5 device intended to operate up to 12.5 MHz on a I3C Basic Bus or up to 1 MHz on a I2C Bus. All TS5 devices respond to specific pre-defined device select code on the I2C/I3C Bus. The DDR5 Temperature Sensor IP provides high-accuracy thermal monitoring for DDR5 memory modules, supporting both DDR5 Temperature Sensor I2C and DDR5 Temperature Sensor I3C interfaces. This DDR5 Memory Temperature Sensor solution is ideal for DDR5 DIMM applications requiring precise thermal management.',
    features: [
  ...
  'pmic-i3c-target-controller': {
    ...
    title: 'Power Management IC I3C Basic Interface IP - PMIC I3C Controller',
    seoKeywords: 'Power Management IC I3C Basic Interface IP, PMIC I3C, PMIC I3C Interface, I3C PMIC, PMIC I3C IP, I3C Interface IP, I3C Basic Interface IP, PMIC Interface IP, Power Management IC I3C, Power Management IC Interface IP, I3C Basic Interface, PMIC Interface, I3C PMIC Interface, PMIC I3C Controller IP, I3C IP for PMIC',
    badges: ['Silicon Proven', 'IP Proven', 'Software IP'],
    overview: 'Power Management IC (PMIC) is designed for DDR5 RDIMM, DDR5 LRDIMM, DDR5 NVDIMM application. PMIC is used for switching and LDO regulators. PMIC-I3C Interface used to select suitable power fit for various application environment. PMIC device is intended to operate up to 12.5MHz. The Power Management IC I3C Basic Interface IP provides a robust PMIC I3C Interface for DDR5 applications, enabling efficient power management and control. This I3C PMIC solution supports both I2C and I3C Basic modes, making it an ideal PMIC I3C Controller IP for next-generation memory systems.',
    features: [
  ...
  'ddr5-rcd03': {
    ...
    title: 'DDR5 Registering Clock Driver IP (DDR5RCD03) - RCD IP Core',
    seoKeywords: 'DDR5 Registering Clock Driver IP, DDR5 RCD, DDR5 RCD IP, DDR5 Registering Clock Driver, DDR5 Registering Clock Driver (RCD), DDR5 RCD IP Core, DDR5 Registering Clock Driver IP Core, DDR5 Clock Driver, DDR5 RCD Controller, DDR5 RCD Controller IP, DDR5 Clock Driver IP, DDR5 RCD Solution, DDR5 Command Address Clock Driver, DDR5 CA Clock Driver, DDR5 Memory Registering Clock Driver',
    badges: ['Silicon Proven', 'IP Proven'],
    overview: 'The DDR5RCD03 is a registering clock driver used on DDR5 RDIMMs and LRDIMMs. Its primary function is to buffer the Command/Address (CA) bus, chip selects, and clock between the host controller and the DRAMs. It also creates a BCOM bus which controls the data buffers for LRDIMMs. The DDR5 Registering Clock Driver IP (DDR5RCD03) is a high-performance DDR5 RCD IP Core designed for DDR5 RDIMM and LRDIMM applications. This DDR5 Clock Driver IP supports DDR5 server speeds up to 6000MT/s and is fully compliant with JEDEC JESD82-513. As a DDR5 RCD Controller IP, it provides advanced features including In-band Interrupt, PEC, and CCC Packet Error Handling.',
    features: [
  ...
  'ddr5-rcd01': {
    ...
    title: 'DDR5 Registering Clock Driver IP (DDR5RCD01) - RCD IP Core',
    seoKeywords: 'DDR5 Registering Clock Driver IP, DDR5 RCD, DDR5 RCD IP, DDR5 Registering Clock Driver, DDR5 Registering Clock Driver (RCD), DDR5 RCD IP Core, DDR5 Registering Clock Driver IP Core, DDR5 Clock Driver, DDR5 RCD Controller, DDR5 RCD Controller IP, DDR5 Clock Driver IP, DDR5 RCD Solution, DDR5 Command Address Clock Driver, DDR5 CA Clock Driver, DDR5 Memory Registering Clock Driver, DDR5 Memory RCD',
    badges: ['Silicon Proven', 'IP Proven'],
    overview: 'The DDR5RCD01 is a registering clock driver used on DDR5 RDIMMs and LRDIMMs. Its primary function is to buffer the Command/Address (CA) bus, chip selects, and clock between the host controller and the DRAMs. It also creates a BCOM bus which controls the data buffers for LRDIMMs. The DDR5 Registering Clock Driver IP (DDR5RCD01) is a silicon-proven DDR5 RCD IP designed for DDR5 RDIMM and LRDIMM applications. This DDR5 Clock Driver IP supports DDR5 server speeds up to 4800MT/s and is fully compliant with JEDEC JESD82-511. As a DDR5 RCD Controller IP, it provides a complete DDR5 RCD Solution for memory-intensive applications.',
    features: [
  ...
  'ckr5-rcd01': {
    ...
    title: 'DDR5 Clock Driver IP - MAXVY DDR5CKD01 Clock Driver',
    seoKeywords: 'DDR5 Clock Driver IP, DDR5 Clock Driver, DDR5 CKD, DDR5 Clock Driver IP Core, DDR5 CKD IP, DDR5 CKD Controller, DDR5 Memory Clock Driver IP, DDR5 Memory Clock Driver, DDR5 Clock Driver Solution, DDR5 Clock Driver Core, DDR5 Clock Management IP, DDR5 Memory Clocking IP, DDR5 Clocking Driver IP, DDR5 Clocking Driver, DDR5 Memory Clocking, DDR5 Clock Management, DDR5 CKD IP Core',
    badges: ['Silicon Proven', 'IP Proven'],
    overview: 'MAXVY DDR5CKD01 is a registering clock driver used on DDR5 CUDIMMs, CSODIMMs, and CAMM. Its primary function is to buffer the DDR clock between the Host controller and the DRAMs. The DDR5 Clock Driver IP (MAXVY DDR5CKD01) is a high-performance DDR5 CKD solution designed for DDR5 CUDIMM, CSODIMM, and CAMM applications. This DDR5 Clock Driver IP Core supports PLL ByPass, Single PLL, and Dual PLL modes with output frequency range from 1000 MHz to 4600 MHz. As a DDR5 CKD Controller, it provides a complete DDR5 Clock Management IP solution with I3C interface up to 12.5 MHz.',
    features: [
  ...
  'mipi-dsi2-transmitter-ip': {
    ...
    title: 'MIPI DSI2 Display Transmitter IP - MAXVY MIPI DSI2 Transmitter',
    seoKeywords: 'MIPI DSI2 Display Transmitter IP, MIPI DSI2 Transmitter IP, MIPI DSI2 Display Transmitter, MIPI DSI2 Transmitter, MIPI DSI2 TX IP, MIPI DSI2 Display Interface IP, MIPI DSI2 Interface IP, MIPI DSI2 Display IP, MIPI DSI2 IP, MIPI DSI2 Transmitter Core, MIPI DSI2 Display IP Core, MIPI DSI2 IP Core, MIPI DSI2 TX Interface IP, MIPI DSI2 Display Controller IP, MIPI DSI2 Controller IP, MIPI DSI2 Display Interface',
    badges: ['Silicon Proven', 'IP Proven', 'Software IP'],
    overview: 'MAXVY MIPI DSI Transmitter IP is designed to transmit the data to the host processor. The MIPI DSI-2 provides the mobile industry a standard, robust, scalable, low-power, high-speed, cost-effective interface that supports a wide range of imaging solutions for mobile devices. The MIPI DSI2 Display Transmitter IP is a fully compliant MIPI DSI2 Transmitter solution supporting C-PHY 2.0 and D-PHY 1.2/2.0/3.0. This MIPI DSI2 TX IP provides a robust MIPI DSI2 Display Interface IP for next-generation display applications, supporting both Command Mode and Video Mode with advanced features like scrambling, lane distribution, and multi-lane support.',
    features: [
  ...
  'mipi-dsi2-receiver-ip': {
    ...
    title: 'MIPI DSI-2 RX Controller IP - MIPI DSI-2 Receiver IP',
    seoKeywords: 'MIPI DSI-2 RX Controller IP, MIPI DSI-2 Receiver IP, MIPI DSI-2 RX IP, MIPI DSI-2 Receiver, MIPI DSI-2 RX Controller, MIPI DSI-2 IP Core, MIPI DSI-2 RX Interface, MIPI DSI-2 Receiver Interface IP, MIPI DSI-2 Interface IP, MIPI DSI-2 Controller IP, MIPI DSI-2 Controller Core, MIPI DSI-2 Display Interface IP, MIPI DSI-2 Display Receiver IP, MIPI DSI-2 RX Core, MIPI DSI-2 Receiver Core, MIPI DSI-2 Display Controller IP',
    badges: ['Silicon Proven', 'IP Proven'],
    overview: "The MAXVY's MIPI DSI-2 RX Controller IP is a fully compliant receive solution designed to interface with MIPI DSI-2 transmitters and deliver display data to SoC video subsystems. The IP supports multi-lane DSI-2 reception over D-PHY and/or C-PHY interfaces through a standard PHY-Protocol Interface (PPI), enabling seamless integration with industry-standard PHY implementations. The MIPI DSI-2 Receiver IP supports DSI-2 V2.2 specification with multi-lane reception up to 4 lanes, error detection, and AXI4-Stream video output, making it an ideal MIPI DSI-2 RX Controller for display applications.",
    features: [
  ...
  'mipi-csi2-v3-transmitter-ip': {
    ...
    title: 'MIPI CSI-2 Transmitter IP V3 - MIPI CSI-2 TX IP',
    seoKeywords: 'MIPI CSI-2 Transmitter IP, MIPI CSI-2 Transmitter, MIPI CSI2 Transmitter IP, MIPI CSI-2 TX IP, MIPI CSI-2 TX Interface IP, MIPI CSI-2 Interface IP, MIPI CSI-2 IP Core, MIPI CSI-2 Transmitter Core, MIPI CSI-2 TX Core, MIPI CSI-2 Controller IP, MIPI CSI-2 Camera Transmitter IP, MIPI CSI-2 Semiconductor IP, MIPI CSI-2 Hardware IP, MIPI CSI-2 Transmitter Interface, MIPI CSI-2 Transmit IP, MIPI CSI-2 Camera Interface IP',
    badges: ['Silicon Proven', 'IP Proven', 'Software IP'],
    overview: 'MIPI CSI-2 (Camera Serial Interface) Transmitter IP defines an interface between a peripheral device (camera) and host processor (application engine) for mobile applications. The MIPI CSI-2 Transmitter IP provides the mobile industry a standard, robust, scalable, low-power, high-speed, cost-effective interface that supports a wide range of imaging solutions for mobile devices. The MIPI CSI-2 Transmitter IP V3 supports C-PHY 2.0 and D-PHY 2.5 for high-bandwidth imaging applications, with data formats including YUV, RGB, and RAW. This MIPI CSI-2 TX IP is ideal for camera interface applications requiring 16-32 virtual channels and advanced scrambling/descrambling features.',
    features: [
  ...
  'mipi-csi2-v3-receiver-ip': {
    ...
    title: 'MIPI CSI-2 Receiver Interface IP V3 - MIPI CSI-2 RX IP',
    seoKeywords: 'MIPI CSI-2 Receiver Interface IP, MIPI CSI-2 RX Interface IP, MIPI CSI-2 RX IP, MIPI CSI-2 V3 Receiver, MIPI CSI2 Receiver IP, MIPI CSI-2 Receiver IP, MIPI CSI-2 Camera Receiver IP, MIPI CSI-2 RX Core, MIPI CSI-2 Receiver Core, MIPI CSI-2 Receiver IP Core, MIPI CSI-2 Interface IP, MIPI CSI-2 Camera Interface IP, MIPI CSI-2 Receiver Interface, MIPI CSI-2 Controller IP, MIPI CSI-2 Hardware IP, MIPI CSI-2 Semiconductor IP',
    badges: ['Silicon Proven', 'IP Proven'],
    overview: 'The MIPI CSI-2 (Camera Serial Interface) defines an interface between a peripheral device (camera) and host processor (application engine) for mobile applications. The MIPI CSI-2 provides the mobile industry a standard, robust, scalable, low-power, high-speed, cost-effective interface that supports a wide range of imaging solutions for mobile devices. The MIPI CSI-2 Receiver Interface IP V3 supports C-PHY 2.0 and D-PHY 2.5, with comprehensive pixel format support including YUV, RGB, and RAW. This MIPI CSI-2 RX IP provides 16-32 virtual channels and advanced error detection for reliable imaging applications.',
    features: [
      'Compliance as per MIPI-CSI-2 version3.0',
      'Compliance with C-PHY 2.0 and D-PHY 2.5 for MIPI CSI-2 Version3.0',
      'Compatibility with I2C and I3C(SDR,DDR) for CCI interface',
  ...
  'mipi-dphy-receiver-ip': {
    ...
    title: 'MIPI D-PHY Receiver IP - MAXVY MIPI D-PHY RX IP',
    seoKeywords: 'MIPI D-PHY Receiver IP, MIPI D-PHY RX Interface IP, MIPI D-PHY RX IP, MIPI D-PHY IP, MIPI D-PHY Interface IP, MIPI D-PHY Receiver, MIPI D-PHY Receiver Core, MIPI D-PHY Receiver Core IP, MIPI D-PHY IP Core, MIPI D-PHY PHY IP, MIPI D-PHY Physical Layer IP, MIPI D-PHY Receiver Interface, MIPI D-PHY RX Core, MIPI D-PHY Receiver PHY IP, MIPI CSI-2 D-PHY Receiver, MIPI CSI-2 PHY IP',
    badges: ['Silicon Proven', 'IP Proven'],
    overview: 'The MAXVY MIPI D-PHY Receiver IP is a robust high-speed PHY solution designed for receiving MIPI data streams in advanced imaging, display, automotive, and embedded applications. The IP supports reliable reception for MIPI CSI-2 and MIPI DSI-2 interfaces with optimized low-power operation, high signal integrity, and seamless SoC integration. The MIPI D-PHY Receiver IP supports up to 2.5 Gbps per lane and 10 Gbps aggregate throughput, making it an ideal MIPI D-PHY RX IP for high-performance imaging systems.',
    features: [
  ...
  'mipi-dphy-transmitter-ip': {
    ...
    title: 'MIPI D-PHY Transmitter IP - MAXVY MIPI D-PHY TX IP',
    seoKeywords: 'MIPI D-PHY Transmitter IP, MIPI D-PHY Transmitter, MIPI D-PHY TX IP, MIPI D-PHY TX Interface IP, MIPI D-PHY PHY IP, MIPI D-PHY IP Core, MIPI D-PHY Transmitter Core IP, MIPI D-PHY Transmitter Core, MIPI D-PHY Interface IP, MIPI D-PHY Physical Layer IP, MIPI D-PHY TX Core, MIPI D-PHY Transmitter Interface, MIPI D-PHY Transmitter PHY IP, MIPI CSI-2 D-PHY Transmitter, MIPI CSI-2 PHY Transmitter IP',
    badges: ['Silicon Proven', 'IP Proven'],
    overview: 'The MAXVY MIPI D-PHY Transmitter IP is a high-performance PHY solution designed for transmitting high-speed data in modern display, camera, automotive, and embedded applications. The IP enables seamless integration with MIPI DSI-2 and MIPI CSI-2 based systems while delivering optimized power, performance, and signal integrity. The MIPI D-PHY Transmitter IP supports up to 2.5 Gbps per lane and 10 Gbps aggregate throughput, making it an ideal MIPI D-PHY TX IP for high-performance display and imaging applications.',
    features: [
      'Compliant with MIPI D-PHY Specification v3.6',
      'Fully Integrated Hard Macro',
  ...
  'qspi-target-ip': {
    ...
    title: 'QSPI Target IP - MAXVY Quad Serial Peripheral Interface',
    seoKeywords: 'QSPI Target IP, Quad SPI Target IP, QSPI IP, QSPI Target, Quad Serial Peripheral Interface IP, QSPI Interface IP, QSPI Controller IP, QSPI IP Core, QSPI Target Controller IP, QSPI Slave IP, QSPI Peripheral IP, QSPI Hardware IP, Quad SPI Interface IP, Quad SPI IP Core, QSPI Slave Controller IP, QSPI Communication IP, Quad SPI Controller IP, QSPI Serial Interface IP, QSPI Memory Interface IP, QSPI Target Controller, QSPI Protocol IP',
    badges: ['Silicon Proven', 'IP Proven', 'Software IP'],
    overview: 'MAXVY Quad Serial Peripheral Interface (QSPI) for Non Volatile Memory Devices, which provides high data throughput, low signal count, and limited backward compatibility with legacy Serial Peripheral Interface (SPI) devices. The QSPI Target IP supports Single Data Rate (SDR) and Double Data Rate (DDR) modes with configurations like 4S-4S-4S, 1S-4S-4S, and more. This Quad SPI Target IP is ideal for non-volatile memory applications requiring high-speed data transfer and low pin count.',
    features: [
  ...
  'ospi-target-ip': {
    ...
    title: 'OSPI Target IP - Octal Serial Peripheral Interface',
    seoKeywords: 'OSPI Target IP, OSPI IP, Octal SPI Target IP, Octal Serial Peripheral Interface IP, OSPI Target, OSPI Interface IP, OSPI Controller IP, OSPI Target Controller IP, OSPI IP Core, OSPI Slave IP, OSPI Slave Controller IP, Octal SPI IP Core, Octal SPI Interface IP, OSPI Hardware IP, OSPI Peripheral IP, OSPI Target Controller, OSPI Memory Interface IP, OSPI Serial Interface IP, Octal SPI Controller IP, OSPI Communication IP, OSPI Protocol IP',
    badges: ['Silicon Proven', 'IP Proven', 'Software IP'],
    overview: 'Octal Serial Peripheral Interface (OSPI) for Non Volatile Memory Devices, which provides high data throughput, low signal count, and limited backward compatibility with legacy Serial Peripheral Interface (SPI) devices. The OSPI Target IP supports Single Data Rate (SDR) and Double Data Rate (DDR) with data transfer rates up to 400MT/s. This Octal SPI Target IP is ideal for high-performance memory applications requiring eight IO ports and Data Strobe support.',
    features: [
      'Support Single Data Rate (SDR) and Double Data Rate (DDR)',
  ...
  'xspi-target-controller': {
    ...
    title: 'xSPI Slave Controller IP - Expanded Serial Peripheral Interface',
    seoKeywords: 'xSPI Slave Controller IP, Expanded SPI Slave Controller, xSPI Slave Controller, xSPI Controller IP, xSPI Slave IP, xSPI IP Core, xSPI Interface IP, xSPI Controller Core, xSPI Interface Controller, xSPI Memory Controller IP, xSPI Memory Interface IP, Expanded Serial Peripheral Interface IP, Expanded SPI IP, xSPI Protocol IP, xSPI Hardware IP, xSPI Peripheral Controller, xSPI Slave Controller Core, xSPI Serial Interface Controller, xSPI Flash Controller IP, xSPI Memory Interface Controller, xSPI Host Interface IP, xSPI Serial Flash Controller IP',
    badges: ['Silicon Proven', 'IP Proven'],
    overview: "The MAXVY's JESD251 Expanded Serial Peripheral Interface Slave controller provides high data throughput, low signal count, and limited backward compatibility with legacy Serial Peripheral Interface(SPI) devices. It is used to connect xSPI Master devices in computing, automotive, Internet of Things, Embedded system and mobile system processor to non-volatile memories, graphics peripherals, networking peripherals, FPGAs, sensors devices. This xSPI Slave Controller IP supports data transfer rates up to 400MT/s with Profile 1.0 and 2.0 commands.",
    features: [
  ...
  'xspi-host-controller': {
    ...
    title: 'xSPI Master Controller IP - Expanded Serial Peripheral Interface',
    seoKeywords: 'xSPI Master Controller IP, xSPI Master Controller, Expanded SPI Master Controller, xSPI Master IP, xSPI Controller IP, xSPI IP Core, Expanded Serial Peripheral Interface IP, xSPI Memory Interface IP, xSPI Master Core, xSPI Memory Controller IP, xSPI Interface IP, xSPI Serial Interface Controller, xSPI Flash Controller IP, xSPI Hardware IP, xSPI Protocol IP, Expanded SPI IP, xSPI Host Interface IP, xSPI Host Controller IP, xSPI Serial Flash Controller IP, xSPI Memory Interface Controller, xSPI Master Controller Core, xSPI Master Interface IP',
    badges: ['Silicon Proven', 'IP Proven'],
    overview: "The MAXVY's Expanded Serial Peripheral Interface (JESD251) Master controller is low signal count, high data bandwidth, primarily for use in computing, automotive, Internet of Things, Embedded system and mobile system processor to connect multiple source of Serial Peripheral Interface (xSPI) slave devices like non-volatile memories, graphics peripherals, networking peripherals, FPGAs, sensors devices. This xSPI Master Controller IP supports single master, multiple slaves, SDR/DDR modes, and data transfer rates up to 400MT/s.",
    features: [
      'Compliance of JEDEC standard JESD251 eXpanded Serial Peripheral Interface (xSPI) for Non Volatile Memory Devices, Version1.0',
  ...
  'mipi-i3c-host-target-ip': {
    ...
    title: 'MIPI I3C Controller Host/Target IP - MAXVY MIPI I3C Controller',
    seoKeywords: 'MIPI I3C Controller IP, MIPI I3C Host Controller IP, MIPI I3C Target Controller IP, MIPI I3C Host/Target IP, MIPI I3C Controller, MIPI I3C IP, I3C Controller IP, I3C Host Controller, I3C Target Controller, MIPI I3C Interface IP, I3C Host/Target IP, I3C Interface IP, MIPI I3C IP Core, I3C Controller Core, I3C Host IP, I3C Target IP, I3C Communication IP, MIPI I3C Hardware IP, MIPI I3C Target IP, I3C Protocol Controller IP, MIPI I3C Host IP, I3C Slave Controller IP, I3C Master Controller IP',
    badges: ['Silicon Proven', 'IP Proven', 'Software IP'],
    overview: 'MIPI I3C Controller IP Core is fully compliant with the latest I3C specification and delivers high bandwidth and scalability for integration of multiple sensors into mobile, automotive and IoT system-on-chips (SoCs). The MIPI I3C Controller supports in-band interrupts within the 2-wire interface provides significantly lower pin count, simplifying board design and reducing power and cost of the system. This MIPI I3C Host/Target IP supports both host and target modes, making it an ideal MIPI I3C Controller IP for multi-sensor systems.',
    features: [
  ...
  'mipi-i3c-target-ip': {
    ...
    title: 'MIPI I3C Slave RTL IP - MIPI I3C Slave (SDR) RTL Design IP',
    seoKeywords: 'MIPI I3C Slave RTL IP, MIPI I3C Slave IP, MIPI I3C SDR IP, MIPI I3C Slave SDR IP, MIPI I3C RTL Design IP, I3C Slave RTL IP, I3C Slave IP, I3C SDR IP, I3C SDR Slave IP, I3C RTL IP, I3C RTL Design, I3C Target IP, I3C Slave Controller IP, MIPI I3C IP Core, I3C Interface IP, MIPI I3C Interface IP, I3C Hardware IP, I3C Protocol IP, I3C RTL Design IP Core, I3C Target RTL IP, MIPI I3C Target IP, I3C SDR Controller IP',
    badges: ['Silicon Proven', 'IP Proven'],
    overview: 'MIPI I3C slave Controller IP Core is fully compliant with the latest I3C specification and delivers high bandwidth and scalability for integration of multiple sensors into mobile, automotive and IoT system-on-chips (SoCs). The MIPI I3C slave Controller supports in-band interrupts within the 2-wire interface provides significantly lower pin count, simplifying board design and reducing power and cost of the system. This MIPI I3C Slave RTL IP supports SDR messaging, dynamic addressing, and hot-join capability.',
    features: [
  ...
  'mipi-i3c-host-ip': {
    ...
    title: 'MIPI I3C Master RTL IP - MIPI I3C Master (SDR) RTL Design IP',
    seoKeywords: 'MIPI I3C Master RTL IP, MIPI I3C Master IP, MIPI I3C SDR IP, MIPI I3C Master SDR IP, MIPI I3C RTL Design IP, I3C Master RTL IP, I3C Master IP, I3C SDR Master IP, I3C SDR IP, I3C RTL IP, I3C RTL Design, MIPI I3C Interface IP, I3C Interface IP, MIPI I3C IP Core, I3C Master Controller IP, I3C Controller RTL IP, I3C Controller IP, MIPI I3C Controller IP, I3C Master RTL Design, I3C Master Controller Core, I3C Protocol IP, I3C Hardware IP',
    badges: ['Silicon Proven', 'IP Proven', 'Software IP'],
    overview: 'MIPI I3C master Controller IP Core is fully compliant with the latest I3C specification and delivers high bandwidth and scalability for integration of multiple sensors into mobile, automotive and IoT system-on-chips (SoCs). The MIPI I3C master Controller supports in-band interrupts within the 2-wire interface provides significantly lower pin count, simplifying board design and reducing power and cost of the system. This MIPI I3C Master RTL IP supports SDR messaging, dynamic addressing, hot-join, and synchronous timing.',
    features: [
      'Compliance as per Public Release Edition',
      'Two wire serial interface up to 12.5 MHz using Push-Pull',
      'Dynamic Addressing while supporting Static Addressing for Legacy I2C Devices',
  ...
  'mipi-i3c-basic-target-controller': {
    ...
    title: 'MIPI I3C Basic Slave Controller IP - MIPI I3C Basic Target Controller',
    seoKeywords: 'MIPI I3C Basic Slave Controller IP, MIPI I3C Basic Slave Controller, MIPI I3C Slave Controller IP, MIPI I3C Basic Slave IP, MIPI I3C Slave IP, I3C Basic Slave Controller IP, I3C Slave Controller IP, I3C Basic Slave IP, I3C Slave IP, MIPI I3C Target Controller IP, I3C Target Controller IP, MIPI I3C Target IP, I3C Target IP, MIPI I3C Controller IP, MIPI I3C Interface IP, I3C Interface IP, I3C Controller Core, I3C Basic Interface IP, I3C Protocol IP, I3C Hardware IP, I3C Slave Controller Core, MIPI I3C IP Core',
    badges: ['IP Proven', 'Software IP'],
    overview: 'MIPI I3C(Improved Inter Integrated Circuit) is a two-wire bidirectional serial Bus for sensors communication. The MIPI I3C interface has been developed to ease sensor system design architectures in mobile sensor and IoT / automotive sensor wireless products by providing a fast, low cost, low power. This MIPI I3C Basic Slave Controller IP supports I3C Basic v1.0 with dynamic addressing, SDR messaging, and in-band interrupts.',
    features: [
  ...
  'mipi-i3c-basic-host-controller': {
    ...
    title: 'MIPI I3C Basic Master Controller IP - MIPI I3C Basic Host Controller',
    seoKeywords: 'MIPI I3C Basic Master Controller IP, MIPI I3C Master Controller IP, MIPI I3C Basic Master Controller, MIPI I3C Basic Master IP, MIPI I3C Master IP, I3C Basic Master Controller IP, I3C Basic Master IP, I3C Master Controller IP, I3C Master IP, MIPI I3C Controller IP, I3C Controller IP, MIPI I3C Interface IP, I3C Interface IP, MIPI I3C IP Core, I3C Controller Core, I3C Master Controller Core, I3C Master IP Core, MIPI I3C Master Core, I3C Basic Interface IP, I3C Protocol Controller IP, I3C Hardware IP, I3C Master RTL IP',
    badges: ['IP Proven', 'Software IP'],
    overview: 'MIPI I3C(Improved Inter Integrated Circuit) is a two-wire bidirectional serial Bus for sensors communication. The MIPI I3C interface has been developed to ease sensor system design architectures in mobile sensor and IoT / automotive sensor wireless products by providing a fast, low cost, low power. This MIPI I3C Basic Master Controller IP supports I3C Basic v1.0 with dynamic addressing, SDR messaging, and hot-join support.',
    features: [
      'Compliance as per MIPI I3C Basic v1.0',
      'Backward compatibility with I2C',
      'Two wire serial interface up to 12.5 MHz using Push-Pull',
  ...
  'mipi-i3c-host-riscv-subsystem': {
    ...
    title: 'MIPI I3C Master RISC-V Subsystem - MIPI I3C Master RISC-V based subsystem',
    seoKeywords: 'MIPI I3C Master RISC-V Subsystem, MIPI I3C Master Subsystem, MIPI I3C RISC-V Subsystem, I3C Master RISC-V Subsystem, MIPI I3C Master IP, I3C Master IP, MIPI I3C Controller IP, I3C Master Controller IP, RISC-V I3C Controller, RISC-V I3C Master, I3C RISC-V IP, MIPI I3C Subsystem IP, I3C Subsystem IP, RISC-V Subsystem IP, I3C Master Subsystem, MIPI I3C Controller Subsystem, RISC-V Based I3C Subsystem, I3C Master Controller Subsystem, RISC-V I3C Master IP, MIPI I3C RISC-V IP, I3C RISC-V Subsystem IP, I3C SoC Subsystem IP',
    badges: ['Silicon Proven', 'IP Proven', 'Software IP'],
    overview: 'RISC-V based MAXVY MIPI I3C master interface has been developed to ease sensor system design architectures in mobile wireless products by providing a fast, low cost, low power, two-wire digital interface for sensors. All the basic functionalities of MIPI I3C master has been proved with Microsemi smart fusion 2 creative development board. In addition MAXVY MIPI I3C master supports for both AHB lite and APB Interface. This MIPI I3C Master RISC-V Subsystem combines the power of RISC-V processing with MIPI I3C master capabilities.',
    features: [
  ...
  'spmi-host-controller': {
    ...
    title: 'MIPI SPMI Host Controller IP - SPMI Host Controller',
    seoKeywords: 'MIPI SPMI Host Controller IP, MIPI SPMI Host Controller, SPMI Host Controller IP, SPMI Host IP, SPMI Controller IP, SPMI Host Controller Core, MIPI SPMI Controller IP, MIPI SPMI Interface IP, SPMI Interface IP, SPMI IP Core, SPMI Controller Core, SPMI Master Controller IP, SPMI Communication IP, SPMI Master IP, SPMI Hardware IP, SPMI Protocol IP, SPMI Host Interface, MIPI SPMI IP, SPMI Host Controller RTL IP, SPMI Host RTL IP, SPMI Power Management Controller IP',
    badges: ['IP Proven', 'Software IP'],
    overview: 'SPMI (System Power Management Interface) Host Controller provides a high-speed, low-latency interface for communication between power management ICs and system processors. This MIPI SPMI Host Controller IP is compliant with MIPI SPMI Specification and supports multiple PMIC devices with low-power operation.',
    features: [
  ...
  'spmi-target-controller': {
    ...
    title: 'MIPI SPMI Target Controller IP - SPMI Target Controller',
    seoKeywords: 'MIPI SPMI Target Controller IP, MIPI SPMI Target Controller, SPMI Target Controller IP, SPMI Target IP, SPMI Target Controller Core, MIPI SPMI Target IP, SPMI Controller IP, MIPI SPMI Controller IP, SPMI Interface IP, MIPI SPMI Interface IP, SPMI IP Core, SPMI Target Core, SPMI Target RTL IP, SPMI Target Controller RTL, SPMI Slave Controller IP, SPMI Slave IP, SPMI Slave Controller Core, SPMI Protocol IP, SPMI Hardware IP, SPMI Communication IP, MIPI SPMI IP, SPMI Power Management IP, SPMI Target Interface, SPMI Peripheral Controller IP, SPMI Target Interface IP',
    badges: ['IP Proven', 'Software IP'],
    overview: 'SPMI (System Power Management Interface) Target Controller enables power management ICs and devices to communicate with system processors over the SPMI bus. This MIPI SPMI Target Controller IP is compliant with MIPI SPMI Specification and supports configurable device addressing, command/data transactions, and error detection.',
    features: [
      'Compliance with MIPI SPMI Specification',
      'Low-power operation',
  ...
  'etsi-ssp-i3c-interface-ip': {
    ...
    title: 'ETSI SSP I3C Interface IP - Secure Service Provider Interface',
    seoKeywords: 'ETSI SSP I3C Interface IP, ETSI SSP I3C Interface, ETSI SSP I3C IP, SSP I3C Interface IP, SSP I3C IP, ETSI SSP Interface, ETSI SSP Interface IP, SSP Interface IP, I3C Interface IP, I3C Protocol IP, I3C IP Core, I3C Controller IP, I3C Interface Core, I3C Hardware IP, I3C RTL IP, MIPI I3C Interface IP, I3C Communication IP, I3C Peripheral Interface, I3C Support Protocol IP, I3C Interface Controller, SSP Protocol IP, SSP Controller IP, ETSI Protocol Interface, ETSI Communication IP',
    badges: ['IP Proven', 'Software IP'],
    overview: 'The ETSI SSP I3C Interface IP enables secure communication between ETSI Secure Service Provider (SSP) devices and I3C-based sensor networks. This ETSI SSP I3C Interface IP provides secure I3C communication with device authentication and secure key management.',
    features: [
  ...
  'ucie-vip': {
    ...
    title: 'UCIe Verification IP - Universal Chiplet Interconnect Express VIP',
    seoKeywords: 'UCIe Verification IP, UCIe VIP, UCIe Verification Solution, UCIe Protocol Verification, UCIe Protocol VIP, UCIe Chiplet Verification, Chiplet Verification IP, UCIe SoC Verification, UCIe Functional Verification, UCIe Compliance Verification, UCIe Verification Solution IP, UCIe PHY Verification, UCIe Interface VIP, UCIe Testbench VIP, UCIe IP Verification, UCIe Design Verification, UCIe Semiconductor Verification, UCIe Protocol Testing, UCIe UVM Verification',
    badges: ['IP Proven', 'Software IP'],
    overview: 'UCIe (Universal Chiplet Interconnect Express) Verification IP provides comprehensive verification of die-to-die interfaces in multi-chiplet designs. This UCIe VIP is compliant with UCIe Specification and supports all UCIe protocol layers for complete chiplet verification.',
    features: [
  ...
  'mipi-i3c-uvm-vip': {
    ...
    title: 'MIPI I3C UVM VIP - MIPI I3C Verification IP',
    seoKeywords: 'MIPI I3C UVM VIP, MIPI I3C Verification IP, I3C Verification IP, I3C VIP, I3C UVM VIP, MIPI I3C VIP, I3C Protocol VIP, I3C Protocol Verification, I3C Interface Verification, I3C Functional Verification, I3C Compliance Verification, I3C UVM Verification, I3C Verification Solution, MIPI I3C Verification Solution, I3C Controller Verification, I3C Host Verification, I3C Target Verification, I3C Protocol Testing, I3C Design Verification, I3C Semiconductor VIP, MIPI I3C Testbench',
    badges: ['IP Proven', 'Software IP'],
    overview: 'MIPI I3C UVM VIP provides a complete verification environment for I3C interfaces, enabling thorough functional verification of I3C host and target designs. This MIPI I3C Verification IP supports Master/Slave/Secondary Master configurations with SDR and HDR modes.',
    features: [
  ...
  'mipi-dsi-vip': {
    ...
    title: 'MIPI DSI Verification IP - MIPI DSI VIP',
    seoKeywords: 'MIPI DSI Verification IP, MIPI DSI VIP, DSI Verification IP, DSI Protocol VIP, MIPI DSI Protocol Verification, MIPI DSI Interface Verification, DSI Functional Verification, DSI Compliance Verification, MIPI DSI Verification Solution, DSI Verification Solution, MIPI DSI UVM VIP, DSI UVM Verification, DSI Controller Verification, DSI Display Verification, MIPI Display Interface VIP, MIPI DSI Verification Solution IP, Display Interface Verification, MIPI DSI Testbench, DSI Semiconductor IP, DSI Design Verification',
    badges: ['IP Proven', 'Software IP'],
    overview: 'MIPI DSI (Display Serial Interface) Verification IP provides comprehensive verification of display interfaces in multimedia and mobile SoC designs. This MIPI DSI VIP supports D-PHY and C-PHY with video and command modes.',
    features: [
  ...
  'mipi-csi-vip': {
    ...
    title: 'MIPI CSI Verification IP - MIPI CSI VIP',
    seoKeywords: 'MIPI CSI Verification IP, MIPI CSI VIP, CSI Verification IP, CSI Protocol VIP, MIPI CSI Protocol Verification, MIPI CSI Interface Verification, MIPI CSI UVM VIP, CSI Compliance Verification, CSI Functional Verification, MIPI CSI Verification Solution, CSI Verification Solution, CSI UVM Verification, CSI Controller Verification, CSI Camera Interface VIP, MIPI Camera Interface Verification, CSI Protocol Testing, CSI Design Verification, CSI Semiconductor IP, MIPI CSI Testbench, Camera Interface Verification, MIPI CSI Verification Solution IP',
    badges: ['IP Proven', 'Software IP'],
    overview: 'MIPI CSI (Camera Serial Interface) Verification IP provides comprehensive verification of camera interfaces in imaging and vision SoC designs. This MIPI CSI VIP supports D-PHY and C-PHY with virtual channel and multi-lane support.',
    features: [
  ...
  'axi-vip': {
    ...
    title: 'AXI Verification IP - AXI VIP',
    seoKeywords: 'AXI Verification IP, AXI VIP, AXI Verification Solution, AXI Protocol VIP, AXI Interface Verification, AXI Functional Verification, AXI Compliance Verification, AMBA AXI VIP, AMBA AXI Verification IP, AXI UVM VIP, AXI Controller Verification, AXI UVM Verification, AXI Bus Verification, AXI Protocol Testing, AXI Design Verification, AXI Testbench, AXI Semiconductor Verification, AXI SoC Verification, AXI Interface VIP, AMBA Protocol Verification',
    badges: ['IP Proven', 'Software IP'],
  ...
  'ahb-lite-master-slave-vip': {
    ...
    title: 'AHB-Lite Verification IP - AHB Lite Master/Slave VIP',
    seoKeywords: 'AHB-Lite Verification IP, AHB-Lite VIP, AHB-Lite Protocol VIP, AHB Master VIP, AHB Slave VIP, AHB Master Slave Verification, AHB Protocol Verification, AHB-Lite Interface Verification, AHB Functional Verification, AHB Compliance Verification, AMBA AHB Verification IP, AHB UVM VIP, AHB UVM Verification, AHB Controller Verification, AHB Bus Verification, AHB Protocol Testing, AHB Design Verification, AHB Testbench, AHB SoC Verification, AHB Semiconductor Verification',
    badges: ['IP Proven', 'Software IP'],
  ...
  'aphy-vip': {
    ...
    title: 'MIPI A-PHY Verification IP - A-PHY VIP',
    seoKeywords: 'MIPI A-PHY Verification IP, A-PHY Verification IP, A-PHY Protocol VIP, MIPI A-PHY Verification, A-PHY Protocol Verification, A-PHY Interface Verification, A-PHY Functional Verification, A-PHY Compliance Verification, Automotive A-PHY VIP, Automotive Verification IP, A-PHY Design Verification, A-PHY Protocol Testing, A-PHY Controller Verification, A-PHY UVM Verification, MIPI A-PHY UVM VIP, Automotive Interface Verification, MIPI Automotive Verification, A-PHY Testbench, Automotive SoC Verification, A-PHY Semiconductor Verification',
    badges: ['IP Proven', 'Software IP'],
    overview: 'A-PHY Verification IP provides comprehensive verification of automotive A-PHY interfaces in automotive and ADAS designs. This MIPI A-PHY VIP supports A-PHY 1.0 and 1.1 with single and dual lane configurations.',
    features: [
  ...
  'cpri-verification-ip': {
    ...
    title: 'CPRI Verification IP - CPRI VIP',
    seoKeywords: 'CPRI Verification IP, CPRI VIP, CPRI Protocol Verification, CPRI Protocol VIP, CPRI Interface Verification, CPRI Functional Verification, CPRI Compliance Verification, CPRI Verification Solution, CPRI UVM VIP, CPRI UVM Verification, CPRI Controller Verification, CPRI Interface VIP, CPRI Design Verification, CPRI Protocol Testing, CPRI Testbench, CPRI SoC Verification, CPRI Semiconductor IP, CPRI Communication Verification, CPRI Network Interface VIP, CPRI Protocol Testing Solution, CPRI Design Verification IP',
    badges: ['IP Proven', 'Software IP'],
  ...
  'jesd204b-uvm-vip': {
    ...
    title: 'JESD204B UVM VIP - JESD204B Verification IP',
    seoKeywords: 'JESD204B UVM VIP, JESD204B Verification IP, JESD204B Protocol VIP, JESD204B VIP, JESD204B Protocol Verification, JESD204B Interface Verification, JESD204B Functional Verification, JESD204B Compliance Verification, JESD204B UVM Verification, JESD204B Verification Solution, JESD204B Controller Verification, JESD204B Serial Interface VIP, JESD204B Link Verification, JESD204B Protocol Testing, JESD204B Design Verification, JESD204B Testbench, JESD204B SoC Verification, JESD204B Semiconductor Verification, JESD204B Interface VIP, High-Speed Interface Verification, JESD204B Verification Solution IP',
    badges: ['IP Proven', 'Software IP'],
  ...
  'lpc-controller-vip': {
    ...
    title: 'LPC Controller Verification IP - Low Pin Count VIP',
    seoKeywords: 'LPC Controller Verification IP, LPC Controller VIP, LPC VIP, LPC Protocol VIP, LPC Verification IP, LPC Protocol Verification, LPC UVM Verification, LPC UVM VIP, LPC Compliance Verification, LPC Functional Verification, LPC Interface Verification, LPC Controller Verification, LPC Bus Verification, LPC Protocol Testing, LPC Design Verification, LPC Testbench, Low Pin Count VIP, LPC Interface VIP, Low Pin Count Verification IP, LPC SoC Verification, LPC Semiconductor Verification',
    badges: ['IP Proven', 'Software IP'],
  ...
  'maxvy-i3c-host-ip-vega': {
    ...
    title: 'MAXVY I3C Host IP - Integrated with VEGA Processor',
    seoKeywords: 'I3C Host IP, I3C Host Controller IP, MIPI I3C Host Controller, I3C Host IP Core, I3C IP Core, I3C Controller IP, I3C Interface IP, I3C RTL IP, MIPI I3C IP, I3C Host Controller RTL, I3C Bus Controller, I3C Protocol IP, I3C Host Solution, I3C Semiconductor IP, I3C SoC IP, I3C Hardware IP, I3C Interface Controller, I3C Communication IP, I3C Design IP',
    badges: ['Silicon Proven', 'IP Proven', 'Software IP'],
  ...
  'maxvy-i3c-target-ip-vega': {
    ...
    heroDescription: 'Powering Next-Gen Sensor Connectivity with VEGA processor integration.',
    title: 'MIPI I3C Target IP - Integrated with VEGA Processor',
    seoKeywords: 'MIPI I3C Target IP, I3C IP Core, I3C Target Controller IP, I3C Target IP Core, MIPI I3C Target Controller, I3C Target Controller, I3C Interface IP, I3C RTL IP, I3C Target RTL, I3C Slave IP, MIPI I3C IP, I3C Protocol IP, I3C Bus Controller, I3C Target Solution, I3C Semiconductor IP, I3C SoC IP, I3C Hardware IP, I3C Interface Controller, I3C Communication IP, I3C Design IP',
    badges: ['Silicon Proven', 'IP Proven', 'Software IP'],
  ...
  'maxvy-xspi-host-ip-vega': {
    ...
    title: 'MAXVY xSPI Host IP - Integrated with VEGA Processor',
    seoKeywords: 'MAXVY xSPI Host IP, xSPI Host IP, xSPI Host Controller IP, xSPI Host Controller, xSPI IP Core, xSPI Interface IP, xSPI Controller IP, xSPI RTL IP, xSPI Host RTL, MIPI xSPI Host IP, xSPI Memory Controller, xSPI Flash Controller, Serial Peripheral Interface IP, Extended SPI Host Controller, xSPI Hardware IP, xSPI Semiconductor IP, xSPI SoC IP, xSPI Interface Controller, xSPI Design IP, xSPI Protocol IP, High Speed SPI Controller',
    badges: ['Silicon Proven', 'IP Proven', 'Software IP'],
  ...
  'maxvy-dsi2-transmitter-ip-vega': {
    ...
    title: 'MIPI DSI-2 Transmitter IP - Integrated with VEGA Processor',
    seoKeywords: 'MIPI DSI-2 Transmitter IP, MIPI DSI2 TX IP, DSI-2 Transmitter, MIPI DSI Transmitter IP, DSI TX Controller IP, MIPI DSI TX Controller, DSI-2 IP Core, MIPI DSI IP Core, DSI Transmitter RTL, MIPI DSI RTL IP, DSI Display Transmitter IP, MIPI Display Serial Interface IP, DSI-2 Controller IP, MIPI Display Interface IP, DSI TX IP Core, DSI Display IP, MIPI DSI Hardware IP, Display Interface Controller, MIPI DSI SoC IP, MIPI DSI Hardware IP',
    badges: ['Silicon Proven', 'IP Proven', 'Software IP'],
  ...
  'maxvy-csi2-receiver-ip-vega': {
    ...
    heroDescription: 'Powering High-Speed Memory Connectivity with VEGA processor integration.',
    title: 'MAXVY CSI-2 Receiver IP - Integrated with VEGA Processor',
    seoKeywords: 'MAXVY CSI-2 Receiver IP, MIPI CSI2 RX IP, CSI-2 Receiver, MIPI CSI Receiver IP, CSI RX Controller IP, MIPI CSI RX Controller, CSI-2 IP Core, MIPI CSI IP Core, CSI Receiver RTL, MIPI CSI RTL IP, CSI-2 Camera Interface IP, MIPI Camera Interface IP, CSI RX IP Core, CSI-2 Controller IP, MIPI CSI-2 Interface, Camera Interface Controller, CSI Semiconductor IP, MIPI CSI SoC IP, MIPI CSI Hardware IP, Camera Sensor Interface IP',
    badges: ['Silicon Proven', 'IP Proven', 'Software IP'],
  ...
  'maxvy-uart-ip-vega': {
    ...
    title: 'MAXVY UART IP - Integrated with VEGA Processor',
    seoKeywords: 'MAXVY UART IP, UART IP Core, UART Controller IP, UART RTL IP, UART Interface IP, UART Controller, UART RTL Design, Serial Communication IP, UART Hardware IP, UART Protocol IP, UART Interface Controller, UART SoC IP, UART Semiconductor IP, UART Peripheral IP, UART Communication Controller, UART Design IP, UART IP Core Design, Serial Interface Controller, UART Embedded IP, UART Module IP, Digital UART IP',
    badges: ['Silicon Proven', 'IP Proven', 'Software IP'],
  ...
  'maxvy-gpio-ip-vega': {
    ...
    title: 'MAXVY GPIO IP - Integrated with VEGA Processor',
    seoKeywords: 'MAXVY GPIO IP, GPIO Controller, GPIO Interface IP, GPIO RTL IP, GPIO Controller IP, GPIO IP Core, GPIO Interface Controller, GPIO Peripheral IP, General Purpose I/O IP, GPIO Hardware IP, GPIO RTL Design, GPIO Design IP, GPIO Module IP, GPIO Semiconductor IP, Digital GPIO IP, GPIO SoC IP, General Purpose Input Output Controller, GPIO Hardware Controller, GPIO Port Controller, Programmable GPIO IP, GPIO Embedded IP',
    badges: ['Silicon Proven', 'IP Proven', 'Software IP'],
  ...
  'maxvy-pwm-ip-vega': {
    ...
    title: 'MAXVY PWM IP - Integrated with VEGA processor',
    seoKeywords: 'MAXVY PWM IP, PWM Controller, PWM Interface IP, PWM RTL IP, PWM Controller IP, PWM IP Core, PWM Generator IP, PWM Peripheral IP, PWM Hardware IP, Pulse Width Modulation IP, PWM RTL Design, PWM Design IP, PWM Module IP, Digital PWM IP, PWM Semiconductor IP, PWM SoC IP, Pulse Width Modulation Controller, PWM Hardware Controller, PWM Signal Generator, Programmable PWM Controller, PWM Embedded IP',
    badges: ['Silicon Proven', 'IP Proven', 'Software IP'],
  ...
  'ucie-controller-ip': {
    ...
    title: 'UCIe Controller IP - Universal Chiplet Interconnect Express',
    seoKeywords: 'UCIe Controller IP, UCIe IP Core, UCIe Interface IP, UCIe Protocol IP, UCIe Controller, UCIe RTL IP, UCIe RTL Design, UCIe Chiplet Interface, UCIe Chiplet IP, UCIe Interconnect IP, UCIe Protocol Controller, UCIe Interface Controller, UCIe Semiconductor IP, UCIe Hardware IP, UCIe SoC IP, UCIe Design IP, Chiplet Interconnect IP, Universal Chiplet Interconnect Express IP, Chiplet Interface IP, UCIe Controller Core, UCIe Connectivity IP',
    badges: ['Silicon Proven', 'IP Proven'],
    overview: 'MAXVY\'s UCIe IP solution includes D2D Adapter layer which supports streaming/PCIe/CXL/Raw flitformats, supports both standard and advanced mainband links and sideband links. This UCIe Controller IP provides a complete UCIe IP Core solution for die-to-die communication with features like ARB/MUX, CRC Computation, Link State Management, and Flit Retry.',
    features: [
      'ARB/MUX',
      'CRC Computation',
  ...
  'avs-bus-host-ip': {
    ...
    title: 'AVS Bus Host IP - Adaptive Voltage Scaling Bus Host Controller',
    seoKeywords: 'AVS Bus Host IP, AVS Bus Host Controller, AVS Host IP, AVS Bus Controller IP, AVS Interface IP, AVS Protocol IP, AVS Host Controller IP, AVS Bus IP Core, AVS RTL IP, AVS RTL Design, AVS Interface Controller, AVS Semiconductor IP, AVS Hardware IP, AVS Bus Interface, AVS Communication IP, AVS Host Controller, AVS Bus Solution, AVS Protocol Controller, AVS Design IP, AVS Controller IP Core, AVS SoC IP',
    badges: ['Silicon Proven', 'IP Proven', 'Software IP'],
  ...
  'avs-bus-target-ip': {
    ...
    title: 'AVS Bus Target IP - Adaptive Voltage Scaling Bus Target Controller',
    seoKeywords: 'AVS Bus Target IP, AVS Target IP, AVS Bus Target Controller, AVS Bus Controller IP, AVS Interface IP, AVS Protocol IP, AVS Semiconductor IP, AVS Interface Controller, AVS RTL IP, AVS RTL Design, AVS Bus IP Core, AVS Target Controller IP, AVS Hardware IP, AVS Bus Interface, AVS Communication IP, AVS Target Controller, AVS Bus Solution, AVS Design IP, AVS Controller IP Core, AVS Protocol Controller, AVS SoC IP',
    badges: ['Silicon Proven', 'IP Proven', 'Software IP'],
  ...
  'gpio-controller-ip': {
    ...
    title: 'GPIO Controller IP - General Purpose Input/Output Controller',
    seoKeywords: 'GPIO Controller IP, GPIO IP Core, GPIO Interface IP, GPIO RTL Design, GPIO Controller, GPIO Hardware IP, General Purpose Input Output IP, General Purpose I/O IP, GPIO Peripheral IP, GPIO Interface Controller, GPIO Control, GPIO Semiconductor IP, Digital GPIO IP, GPIO Module IP, GPIO Design IP, GPIO Embedded IP, Programmable GPIO IP, GPIO Port Controller, GPIO Hardware Controller, GPIO Control IP',
    badges: ['Silicon Proven', 'IP Proven', 'Software IP'],
  ...
  'riscv-instruction-set': {
    ...
    title: 'RISC-V RV32I Base Instruction Set - RISC-V Instruction Set Architecture',
    seoKeywords: 'RISC-V RV32I Base Instruction Set, RISC-V RV32I instruction set, RV32I instruction set, RISC-V base instruction set, RISC-V RV32I, RV32I base ISA, RISC-V ISA, RISC-V instructions, RISC-V instruction set architecture, RV32I instructions, RISC-V 32-bit instruction set, RISC-V processor instruction set, RISC-V CPU instruction set, RISC-V base ISA, RISC-V integer instruction set, RISC-V SUB instruction, RISC-V ADD instruction, RISC-V SLT instruction, RISC-V SLL instruction, RV32I integer instructions, RISC-V SLTU instruction, RISC-V XOR instruction, RISC-V SRL instruction, RISC-V SRA instruction, RISC-V OR instruction, RISC-V AND instruction, RISC-V R-format instructions, RISC-V arithmetic instructions, RISC-V processor architecture, RISC-V logical instructions, RISC-V open ISA',
    badges: ['IP Proven', 'Software IP'],
  ...
  'riscv-core-development': {
    ...
    title: 'RISC V Core Development - RISC-V CPU Design and Processor Development',
    seoKeywords: 'RISC V Core Development, RISC-V CPU design, RISC-V processor design, RISC-V core design, RISC-V CPU development, RISC-V processor development, RISC-V hardware development, RISC-V custom core development, RISC-V core IP, RISC-V processor IP, RISC-V core development IP, RISC-V custom processor, RISC-V processor development solutions, RISC-V core design services, RISC-V processor architecture, RISC-V architecture development, RISC-V semiconductor IP, RISC-V hardware design, RISC-V ISA development, RISC-V CPU architecture',
    badges: ['Silicon Proven', 'IP Proven'],
  ...
  'riscv-reference-model': {
    ...
    title: 'RISC-V ISA Reference Model - RISC-V Processor Reference Model',
    seoKeywords: 'RISC-V ISA Reference Model, RISC-V Processor Reference Model, RISC-V Reference Model IP, RISC-V Verification Model, RISC-V ISA Verification, RISC-V Processor Verification, RISC-V Simulation Model, RISC-V Architectural Model, RISC-V CPU Reference Model, RISC-V Design Verification, RISC-V Core Model, RISC-V Verification IP, RISC-V Processor Model, RISC-V Core Verification, RISC-V Hardware Verification, RISC-V Reference Design, RISC-V Software Model, RISC-V Architecture Verification, RISC-V Functional Verification, RISC-V ISA Model',
    badges: ['IP Proven', 'Software IP'],
  ...
  'cloud-based-qr-generator': {
    ...
    title: 'Cloud Based Dynamic QR Code Generator - Real-Time QR Code Solution',
    seoKeywords: 'Cloud Based Dynamic QR Code Generator, Cloud QR Code Generator, Dynamic QR Code Generator, Cloud-Based QR Code Generator, Dynamic QR Code Software, Online Dynamic QR Code Generator, Cloud QR Code Software, Dynamic QR Code Solution, Real-Time QR Code Generator, Cloud-Based QR Code Solution, Dynamic QR Code System, QR Code Generator Software, Dynamic QR Code Platform, Cloud QR Code Solution, QR Code Management Software, Cloud QR Code Management, Dynamic QR Code Management, Real-Time QR Code Software, Cloud-Connected QR Code Generator, Dynamic QR Code Technology, QR Code Generation Software',
    badges: ['Software IP'],
  ...
  'maxvy-i3c-host-software': {
    ...
    title: 'MAXVY I3C Host Controller Software - MIPI I3C Protocol Software',
    seoKeywords: 'MAXVY I3C HOST CONTROLLER SOFTWARE, I3C Host Controller Software, MAXVY I3C Host Controller, MIPI I3C Host Controller, I3C Controller Software, I3C Host Software, I3C Protocol Software, MIPI I3C Software, I3C Verification Software, I3C Protocol Verification, I3C Compliance Testing, I3C Host Interface, I3C Software Solution, I3C Protocol Testing, I3C Interface Software, I3C Host Controller, MIPI I3C Protocol Solution, I3C Interface Controller, I3C Test Software, I3C Controller Solution, MIPI I3C Verification',
    badges: ['IP Proven', 'Software IP'],
